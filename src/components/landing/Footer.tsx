      ...
      <div className="max-w-6xl mx-auto px-4 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-white">Radon Black Box Edition AI</h3>
            <p className="text-white/60 leading-relaxed">
              Мета-когнитивная AI система нового поколения. 
              Часть революционной AGI архитектуры из 18 специализированных модулей.
            </p>
          </div>

          {/* Team section */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-white">Команда</h4>
            <div className="space-y-2">
              <p className="text-white/70">Разработчик</p>
        ...
        <div className="border-t border-white/10 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/40 text-sm">
            © 2025 Radon AI. All rights reserved.
          </p>
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            <span className="text-white/40 text-sm">Beta Version</span>
